...
<div class="min-h-screen bg-gray-50 py-10">
    <div class="max-w-4xl mx-auto px-4 md:px-10">
        ...
        <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
            <div>
                <h2 class="text-3xl font-bold text-gray-900 tracking-tight">Ubah Kategori</h2>
                ...
                <form action="{{ route('seller.categories.update', $category->id) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4"
                                  class="w-full rounded-xl border-gray-200 bg-gray-50 px-3 py-2.5 text-sm
                                         focus:border-pink-500 focus:ring-pink-500">{{ old('description', $category->description) }}</textarea>
                    </div>
